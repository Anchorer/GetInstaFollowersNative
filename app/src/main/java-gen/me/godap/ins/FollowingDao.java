...
public class FollowingDao extends AbstractDao<Following, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Following entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Following entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Following entity, long rowId) {
    ...
    @Override
    public boolean hasKey(Following entity) {
